...
import { GoogleTestimonials } from '../components/home/GoogleTestimonials'
    ...
    <>
      <section className="relative flex min-h-screen items-center overflow-hidden">
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-20 pt-32 sm:pt-36">
          <div
            className="inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-sm font-medium text-white/90 backdrop-blur-sm mb-6 animate-enter"
          >
            <Sparkles className="h-4 w-4" />
            {t.home.eyebrow}
          </div>
          <h1
            className="max-w-3xl text-4xl font-extrabold leading-[1.1] tracking-tight text-white sm:text-5xl lg:text-6xl animate-enter"
            style={{ animationDelay: '100ms' }}
          >
            {t.home.title}
          </h1>
          <p
            className="mt-6 max-w-xl text-lg text-white/80 leading-relaxed animate-enter"
            style={{ animationDelay: '200ms' }}
          >
            {t.home.subtitle}
          </p>
          <div
            className="mt-10 flex flex-wrap gap-4 animate-enter"
      ...
      <section className="mx-auto max-w-6xl px-4 py-20">
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {t.home.features.map((item, i) => {
            ...
            return (
              <Reveal key={item.title} delay={i * 100} variant="up">
                <div className="group rounded-2xl border border-slate-100 bg-white p-6 text-center shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
      ...
      <section className="bg-gradient-to-b from-slate-50 to-white py-20">
        <div className="mx-auto max-w-6xl px-4">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6">
            {localized.map((exp, i) => (
              <Reveal key={exp.id} delay={i * 120} variant="scale" className="w-full max-w-sm">
      ...
      <Reveal as="section" variant="fade" className="relative overflow-hidden bg-ocean-700 py-20 text-white">
