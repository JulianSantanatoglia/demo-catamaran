...
export function About() {
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-14">
      ...
      <Reveal variant="scale" delay={100} className="mt-10 overflow-hidden rounded-3xl shadow-lg ring-1 ring-slate-100">
        <img
      ...
      <Reveal delay={150} className="mt-10 max-w-none">
      ...
      <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
        {t.about.stats.map((stat, i) => {
          ...
          return (
            <Reveal key={stat.label} delay={i * 100} variant="up">
